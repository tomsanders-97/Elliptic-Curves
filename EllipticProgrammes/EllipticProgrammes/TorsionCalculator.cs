                    ...
                    else
                    {
                        ...
                        else
                        {
                            do
                            {
                                ...
                                //if ((xInterim == Math.Floor(xInterim)) || (yInterim == Math.Floor(yInterim)))
                                //if ((Math.Abs(xInterim - Math.Floor(xInterim)) <= float.Epsilon) || (Math.Abs(yInterim - Math.Floor(yInterim)) <= float.Epsilon))
                                //if ((xInterim == (int)xInterim) || (yInterim == (int)yInterim))
